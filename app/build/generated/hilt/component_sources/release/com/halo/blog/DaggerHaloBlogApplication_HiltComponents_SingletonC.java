...
public final class DaggerHaloBlogApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends HaloBlogApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(CategoryTagViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(PostViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(TagViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends HaloBlogApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.tagViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.halo.blog.ui.viewmodel.CategoryTagViewModel", ((Provider) categoryTagViewModelProvider)).put("com.halo.blog.ui.viewmodel.PostViewModel", ((Provider) postViewModelProvider)).put("com.halo.blog.ui.viewmodel.TagViewModel", ((Provider) tagViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.halo.blog.ui.viewmodel.PostViewModel 
          return (T) new PostViewModel(singletonCImpl.haloRepositoryProvider.get());

          case 2: // com.halo.blog.ui.viewmodel.TagViewModel 
